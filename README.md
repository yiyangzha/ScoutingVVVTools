...
- `selections/mix/config.json`: mix-step tree selection, input/output ROOT roots and patterns, sample config, threading for the input-chunk scan, and deterministic `random_state`.
