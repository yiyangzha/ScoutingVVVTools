...
- `selections/signal_region/config.json`: signal-region scan settings: `lumi`, `n_signal_regions` / `N`, `bdt_root`, `output_dir`, `min_bkg_weight`, `max_edge_candidates_per_axis`, `beam_width`, `top_intervals_per_axis`, `coordinate_rounds`, `local_refine_rounds`, `local_refine_neighbor_edges`, `local_refine_top_candidates`, `candidate_pool_limit`, `progress_every_seconds`, and `seed_quantiles`.
